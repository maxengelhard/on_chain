...
class TelegramManager:
    def __init__(self) -> None:
        ...
        self.csv_file = 'account_values.csv'
        self.df = None
    ...
    async def send_telegram_acc_message(self, total_value, aevo_value, hyper_value):
    ...
    async def send_acc_message(self):
        ...
        await self.send_telegram_acc_message(total_value, aevo_value, hyper_value)
